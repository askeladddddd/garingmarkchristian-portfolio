# Mark Christian Garing — Software Engineering Portfolio
...
- **React.js** (v18)
- **Vite** (Build Tool)
- **Vanilla CSS Modules** (No UI frameworks used — 100% custom styling)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/askeladddddd/portfolio.git
   cd portfolio
   ```
...
- **LinkedIn:** [Mark Christian Garing](https://www.linkedin.com/in/mark-christian-garing-668593412)
- **GitHub:** [@askeladddddd](https://github.com/askeladddddd)
